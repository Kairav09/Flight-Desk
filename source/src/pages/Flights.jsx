  ...
  async function loadFlights() {
    ...
    try {
      ...
      const res = await fetch(
        `https://aerodatabox.p.rapidapi.com/flights/airports/iata/${airportFilter}/${start}/${end}?withLeg=true&direction=${dir}&withCancelled=true&withCodeshared=true&withCargo=false&withPrivate=false`,
        {
          headers: {
